      ...
      <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              <h4 className="font-semibold mb-4 text-green-400">Employers</h4>
              <ul className="space-y-2 text-sm">
                <li><Link to="/employer-training" className="text-gray-300 hover:text-white transition-colors">Training Programs</Link></li>
                ...
                <li><Link to="/employer-training#placement" className="text-gray-300 hover:text-white transition-colors">Job Placement</Link></li>
              </ul>
            </div>
