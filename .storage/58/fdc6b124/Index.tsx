        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl p-8 md:p-16">
          <div className="text-center space-y-8">
            ...
            <h2 className="text-4xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">
              Free Inclusive Employer Training Program
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 max-w-4xl mx-auto">
              <p className="text-yellow-800 font-medium">
                <strong>Qualification Requirement:</strong> To qualify for our free Inclusive Employer Training Program, 
                you must offer job and internship placement opportunities for our graduates.
              </p>
            </div>
