              ...
              {user ? (
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Button asChild size="sm" className="bg-gradient-to-r from-blue-600 via-gray-800 to-red-600 hover:opacity-90">
                    <Link to="/?signup=true">Get Started</Link>
                  </Button>
                </div>
              )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="mailto:info@sign2code.com" className="text-gray-300 hover:text-white transition-colors">Contact Us</a></li>
                <li><Link to="/accessibility" className="text-gray-300 hover:text-white transition-colors">Accessibility</Link></li>
                <li><a href="https://www.brightermonday.co.ke/jobs" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">BrighterMonday Jobs</a></li>
                <li><a href="https://powerlearnprojectafrica.org/talent-hub/job-opportunities" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">Power Learn Talent Hub</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 space-y-4">
            <div className="text-center text-gray-400 text-sm">
              <p className="mb-2">
                <strong>Founded and Developed by:</strong> Rosemary Emeli (Nigeria) & Gideon Thuku (Kenya)
              </p>
              <p className="mb-2">
                <strong>Organization:</strong> Africa Ability Trust
              </p>
              <p>
                © 2025 Sign-to-Code. Making digital education accessible for everyone.
              </p>
            </div>
          </div>
        </div>
