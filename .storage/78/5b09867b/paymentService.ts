...
class PaymentService {
  ...
  constructor() {
    ...
    this.publishableKey = import.meta.env.VITE_INTASEND_PUBLISHABLE_KEY || 'ISPubKey_test_your_key_here'
    this.secretKey = import.meta.env.VITE_INTASEND_SECRET_KEY || 'ISSecretKey_test_your_key_here'
